...
public class StickoredoorBlock extends ThiccSticcModElements.ModElement {
	@ObjectHolder("thicc_sticc:stickoredoor")
	public static final Block block = null;
	public StickoredoorBlock(ThiccSticcModElements instance) {
		super(instance, 5);
	}
