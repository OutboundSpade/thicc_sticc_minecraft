...
public class ThiccsticcingotItem extends ThiccSticcModElements.ModElement {
	@ObjectHolder("thicc_sticc:thiccsticcingot")
	public static final Item block = null;
	public ThiccsticcingotItem(ThiccSticcModElements instance) {
		super(instance, 17);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("thiccsticcingot");
		}
